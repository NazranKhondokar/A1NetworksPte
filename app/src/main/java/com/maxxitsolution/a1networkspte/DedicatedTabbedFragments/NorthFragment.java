...
public class NorthFragment extends Fragment {
    ...
    private static final String TAG = NorthFragment.class.getSimpleName();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(com.maxxitsolution.a1networkspte.R.layout.fragment_north, container, false);
