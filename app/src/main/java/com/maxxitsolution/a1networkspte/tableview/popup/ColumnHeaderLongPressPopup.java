package com.maxxitsolution.a1networkspte.tableview.popup;
...
public class ColumnHeaderLongPressPopup extends PopupMenu implements PopupMenu
    ...
    private void createMenuItem() {
        this.getMenu().add(Menu.NONE, ASCENDING, 0, mContext.getString(com.maxxitsolution.a1networkspte.R.string.sort_ascending));
        this.getMenu().add(Menu.NONE, DESCENDING, 1, mContext.getString(com.maxxitsolution.a1networkspte.R.string.sort_descending));
