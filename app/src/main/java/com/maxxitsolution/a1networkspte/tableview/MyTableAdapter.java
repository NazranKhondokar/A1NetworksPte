...
import com.maxxitsolution.a1networkspte.tableview.holder.CellViewHolder;
import com.maxxitsolution.a1networkspte.tableview.holder.ColumnHeaderViewHolder;
import com.maxxitsolution.a1networkspte.tableview.holder.GenderCellViewHolder;
import com.maxxitsolution.a1networkspte.tableview.holder.MoneyCellViewHolder;
import com.maxxitsolution.a1networkspte.tableview.holder.RowHeaderViewHolder;
...
public class MyTableAdapter extends AbstractTableAdapter<ColumnHeaderModel, RowHeaderModel,
    ...
    public RecyclerView.ViewHolder onCreateCellViewHolder(ViewGroup parent, int viewType) {
        ...
        switch (viewType) {
            case GENDER_TYPE:
                ...
                layout = LayoutInflater.from(m_jContext).inflate(com.maxxitsolution.a1networkspte.R.layout
            ...
            default:
                ...
                layout = LayoutInflater.from(m_jContext).inflate(com.maxxitsolution.a1networkspte.R.layout.tableview_cell_layout,
                        parent, false);
    ...
    public RecyclerView.ViewHolder onCreateColumnHeaderViewHolder(ViewGroup parent, int viewType) {
        View layout = LayoutInflater.from(m_jContext).inflate(com.maxxitsolution.a1networkspte.R.layout
    ...
    public View onCreateCornerView() {
        return LayoutInflater.from(m_jContext).inflate(com.maxxitsolution.a1networkspte.R.layout.tableview_corner_layout, null,
                false);
    }
