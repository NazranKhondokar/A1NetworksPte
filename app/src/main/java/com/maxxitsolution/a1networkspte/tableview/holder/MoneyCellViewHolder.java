...
public class MoneyCellViewHolder extends AbstractViewHolder {
    ...
    public MoneyCellViewHolder(View itemView) {
        super(itemView);
        cell_textview = itemView.findViewById(com.maxxitsolution.a1networkspte.R.id.money_cell_data);
        cell_container = itemView.findViewById(com.maxxitsolution.a1networkspte.R.id.cell_container);
    }
    ...
    public void setSelected(SelectionState p_nSelectionState) {
        ...
        if (p_nSelectionState == SelectionState.SELECTED) {
            changeColorOfMoneyTextView(com.maxxitsolution.a1networkspte.R.color.selected_text_color);
        } else {
            changeColorOfMoneyTextView(com.maxxitsolution.a1networkspte.R.color.unselected_text_color);
        }
    }
