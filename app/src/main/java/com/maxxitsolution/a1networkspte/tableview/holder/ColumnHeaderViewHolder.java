...
public class ColumnHeaderViewHolder extends AbstractSorterViewHolder {
    ...
    public ColumnHeaderViewHolder(View itemView, ITableView pTableView) {
        ...
        column_header_textview = itemView.findViewById(com.maxxitsolution.a1networkspte.R.id.column_header_textView);
        column_header_container = itemView.findViewById(com.maxxitsolution.a1networkspte.R.id.column_header_container);
        column_header_sort_button = itemView.findViewById(com.maxxitsolution.a1networkspte.R.id.column_header_sort_imageButton);
    ...
    public void setSelected(SelectionState p_nSelectionState) {
        ...
        if (p_nSelectionState == SelectionState.SELECTED) {
            nBackgroundColorId = com.maxxitsolution.a1networkspte.R.color.selected_background_color;
            nForegroundColorId = com.maxxitsolution.a1networkspte.R.color.selected_text_color;

        } else if (p_nSelectionState == SelectionState.UNSELECTED) {
            nBackgroundColorId = com.maxxitsolution.a1networkspte.R.color.unselected_header_background_color;
            nForegroundColorId = com.maxxitsolution.a1networkspte.R.color.unselected_text_color;

        } else { // SelectionState.SHADOWED

            nBackgroundColorId = com.maxxitsolution.a1networkspte.R.color.shadow_background_color;
            nForegroundColorId = com.maxxitsolution.a1networkspte.R.color.unselected_text_color;
        }
    ...
    private void controlSortState(SortState pSortState) {
        if (pSortState == SortState.ASCENDING) {
            ...
            column_header_sort_button.setImageResource(com.maxxitsolution.a1networkspte.R.drawable.ic_down);

        } else if (pSortState == SortState.DESCENDING) {
            column_header_sort_button.setVisibility(View.VISIBLE);
            column_header_sort_button.setImageResource(com.maxxitsolution.a1networkspte.R.drawable.ic_up);
        } else {
