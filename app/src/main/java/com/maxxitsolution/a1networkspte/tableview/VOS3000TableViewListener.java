...
import com.maxxitsolution.a1networkspte.VOSBuyActivity;
...
public class VOS3000TableViewListener implements ITableViewListener {

    private final String TAG = VOS3000TableViewListener.this.getClass().getSimpleName();
    private ITableView mTableView;
    private Context context;
    private List<VOS3000> userInfoList;

    public VOS3000TableViewListener(ITableView pTableView, Context context, List<VOS3000> userInfoList) {
    ...
    public void onCellClicked(@NonNull RecyclerView.ViewHolder p_jCellView, int p_nXPosition, int
        ...
        Intent intent = new Intent(context, VOSBuyActivity.class);
        intent.putExtra("VOS3000", userInfoList.get(p_nYPosition));
